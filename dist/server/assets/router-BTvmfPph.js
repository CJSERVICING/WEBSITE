...
const appCss = "/assets/styles-d7kkqnih.css";
...
const logo = "/assets/logo-B_rwuqba.png";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 w-full border-b border-border/60 bg-background/85 backdrop-blur-xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 font-display font-bold text-lg", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "CJ Servicing" })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden items-center gap-3 md:flex", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, variant: "cta", size: "sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", children: "Get a Quote" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border bg-background md:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col p-4", children: [
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "border-t border-border bg-secondary/40", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-7xl gap-8 px-4 py-12 sm:px-6 md:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 font-display text-lg font-bold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-9 w-9 items-center justify-center rounded-lg bg-[image:var(--gradient-hero)] text-primary-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-5 w-5" }) }),
          "CJ Servicing"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-muted-foreground", children: "Affordable, reliable exterior cleaning across Nottingham & Derby." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-muted-foreground", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/pricing", className: "hover:text-foreground", children: "Pricing & Calculator" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", className: "hover:text-foreground", children: "Contact & Quote" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "mb-3 text-sm font-semibold", children: "Get in Touch" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-4 w-4 text-accent" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:07554639668", className: "hover:text-foreground", children: "07554639668" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-4 w-4 text-accent" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:ServicingCJ@gmail.com", className: "hover:text-foreground", children: "ServicingCJ@gmail.com" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border py-4 text-center text-xs text-muted-foreground", children: [
      ...
      " CJ Servicing. DM, Call, or Email to Book."
    ] })
  ] });
}
...
const Route$5 = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Affordable, reliable pressure washing, window cleaning & lawn mowing across Nottingham and Derby. Same-day quotes — call 07554639668."
      },
...
const $$splitComponentImporter$4 = () => import("./services-CGnwEqIX.js");
const Route$4 = createFileRoute("/services")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Pressure washing £2.50/sqm, window cleaning from £2.50, lawn mowing £0.25/sqm in Nottingham & Derby."
    }, {
      property: "og:title",
      content: "Services — CJ Servicing"
    }, {
      property: "og:description",
      content: "Pressure washing, window cleaning and lawn mowing across Nottingham & Derby."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./pricing-e5l2Xym6.js");
const Route$3 = createFileRoute("/pricing")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Transparent prices for pressure washing, windows and lawn mowing. Use the calculator for an instant estimate."
    }, {
      property: "og:title",
      content: "Pricing & Calculator — CJ Servicing"
    }, {
      property: "og:description",
      content: "Instant estimates for exterior cleaning across Nottingham & Derby."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./gallery-DIKPczky.js");
const Route$2 = createFileRoute("/gallery")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "See our before and after cleaning results from projects across Nottingham & Derby."
    }, {
      property: "og:title",
      content: "Gallery — CJ Servicing"
    }, {
      property: "og:description",
      content: "Before and after photos of our professional exterior cleaning work."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./contact-BGpSjeJq.js");
const Route$1 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Call 07554639668 or email ServicingCJ@gmail.com for a free quote on exterior cleaning in Nottingham & Derby."
    }, {
      property: "og:title",
      content: "Contact CJ Servicing"
    }, {
      property: "og:description",
      content: "Free quotes — usually same day. Call 07554639668 or email ServicingCJ@gmail.com."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const heroImg = "/assets/hero-kpw7BTwA.jpg";
const $$splitComponentImporter = () => import("./index-Bl4gW7HU.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Professional pressure washing, window cleaning and lawn mowing across Nottingham & Derby. Same-day quotes. Call 07554639668."
    }, {
      property: "og:title",
      content: "CJ Servicing — Exterior Cleaning in Nottingham & Derby"
    }, {
      property: "og:description",
